...
import com.biao.readersex.adapter.SettingAdapter;
...
public class SettingActivity extends Activity implements OnPreferenceChangeListener{
	...
	String[] items = { "意见反馈", "检查更新","赏个好评","QQ群：489836967", "清除缓存", "关于" };
	int vc;// 获取当前版本号
	File sdcardDir;
	String path;
	File f;
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case 1:
					...
					break;
				case 2:
					Intent i = getIntent(SettingActivity.this,"com.biao.readersex");
				...
				case 4:
					...
					break;
				case 5:
					it.setClass(getApplicationContext(), AboutActivity.class);
					startActivity(it);
					break;
